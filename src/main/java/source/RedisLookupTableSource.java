...
public class RedisLookupTableSource implements
    ...
    public DataStream<Row> getDataStream(StreamExecutionEnvironment execEnv) {
        return execEnv.createInput(this.getInputFormat(), this.getReturnType()).name(this.explainSource());

    }

    private RedisRowInputFormat getInputFormat() {
        return RedisRowInputFormat.buildRedisInputFormat().build();
    }
