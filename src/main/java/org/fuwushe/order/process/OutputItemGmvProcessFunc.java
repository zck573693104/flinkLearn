...
public class OutputItemGmvProcessFunc extends KeyedProcessFunction<Tuple, OrderAccumulator, Tuple2<String,String>> {
    ...
    public void open(Configuration parameters) throws Exception{
        ...
        state = this.getRuntimeContext()
                .getMapState(new MapStateDescriptor<>("state_item_order_gmv",String.class,OrderAccumulator.class));
    }
    ...
    public void processElement(OrderAccumulator value, Context ctx,
        ...
        String key = value.getOrderType()+"_"+value.getDate()+"@"+value.getItemId();
        ...
        if (cachedValue == null || cachedValue.getSubOrderDetailSum()!= value.getSubOrderDetailSum()) {
            ...
            result.put("itemId", value.getItemId());
