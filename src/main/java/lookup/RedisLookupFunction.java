...
public class RedisLookupFunction extends AsyncTableFunction<Row> {
    ...
    public RedisLookupFunction(String[] fieldNames, TypeInformation[] fieldTypes, String ip, int port, long cacheMaxSize, long cacheExpireMs, String password) {
    ...
    public void eval(CompletableFuture<Collection<Row>> future, String key) throws ExecutionException, InterruptedException {
    ...
    public static class Builder {
        ...
        public RedisLookupFunction build() {
            return new RedisLookupFunction(fieldNames, fieldTypes, ip, port, cacheMaxSize, cacheExpireMs,password);
        }
    }
}
