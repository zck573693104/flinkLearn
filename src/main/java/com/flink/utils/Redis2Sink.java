...
public class Redis2Sink<IN> extends RichSinkFunction<IN> {

    private static final long serialVersionUID = 1L;

    private static final Logger LOG = LoggerFactory.getLogger(Redis2Sink.class);
    ...
    /**
     * Creates a new {@link Redis2Sink} that connects to the Redis server.
     *
     ...
     */
    public Redis2Sink(FlinkJedisConfigBase flinkJedisConfigBase, RedisMapper<IN> redisSinkMapper) {
    ...
    public void invoke(IN input) throws Exception {
        ...
        switch (redisCommand) {
            ...
            case PUBLISH:
                ...
                break;
            case ZADD:
                    this.redisCommandsContainer.zadd(LocalDate.now() +":"+this.additionalKey, value, key);
                break;
            case HSET:
                this.redisCommandsContainer.hset(LocalDate.now() +":"+this.additionalKey, key, value);
                break;
            default:
