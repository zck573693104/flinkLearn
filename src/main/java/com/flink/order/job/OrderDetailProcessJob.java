package com.flink.order.job;

import com.alibaba.fastjson.JSONObject;
import com.flink.constant.RedisConstants;
import com.flink.kafka.KafkaProperties;
import com.flink.kerberos.Kerberos;
import com.flink.order.aggreate.OrderAndGmvAggregateFunc;
import com.flink.order.process.OutputCategoryCodeGmvProcessFunc;
import com.flink.order.process.OutputItemGmvProcessFunc;
import com.flink.order.vo.OrderVO;
import com.flink.utils.Redis2Sink;
...
import com.flink.config.EnvUtil;
import com.flink.item.WindowResultFunction;
import com.flink.order.OrderAccumulator;
import com.flink.order.aggreate.ItemSalesAggregateFunc;
import com.flink.order.rich.FilTerOldOrderData;
import com.flink.order.process.ItemProcessFunc;
import com.flink.sink.redis.GmvRedisMapper;
import com.flink.sink.redis.RankingRedisMapper;
import com.flink.utils.RedisUtil;
